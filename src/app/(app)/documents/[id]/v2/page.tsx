            ...
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
              ...
              <div className="flex flex-wrap items-center gap-3">
                ...
                {hasV2 && canApprove && document.workflowStatus === WorkflowStatus.V2_COMPLETED && (
                  <button
                    onClick={() => router.push(`/documents/${documentId}/approve`)}
                    className="px-5 py-2.5 rounded-xl text-white bg-gradient-to-r from-emerald-600 to-teal-600 shadow-lg hover:shadow-xl transition-all"
                  >
                    Approve Document
                  </button>
                )}
            ...
            {hasV2 && v2Data && canEdit && (
              <div className="bg-white/80 backdrop-blur-xl border border-white/40 rounded-2xl shadow p-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                <div className="text-sm text-slate-600">
                  Make updates to extracted content only. Structure and order are preserved.
